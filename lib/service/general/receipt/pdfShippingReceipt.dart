...
class PDFShippingReceipt {
  static Future<File> generateStockShipping(ShippingReceipt receipt) async {
    ...
    pdf.addPage(
        pw.MultiPage(
          ...
          build: (context) => [
            ...
            buildInvoiceHeaderCells(receipt.shipping),
            buildInvoice(receipt.shipping),
            pw.Divider(),
            buildInvoiceNewTotal(receipt.shipping),
  ...
  static pw.Widget buildHeader(ShippingReceipt receipt) => pw.Column(
  ...
  static pw.Widget buildHeader2(ShippingReceipt receipt) => pw.Column(
    crossAxisAlignment: pw.CrossAxisAlignment.start,
    children: [
      pw.Row(
        crossAxisAlignment: pw.CrossAxisAlignment.start,
      ...
      Row(
          children:[
            Container(
                ...
                //flex: 2,
                child: Container(
                    child: Text(' ${recpt.companyShippingPermissionNo}',style: const TextStyle(fontSize: 18),textAlign: TextAlign.left))),
  ...
  static pw.Widget buildCompanyLogo2(ShippingReceipt receipt) => pw.Column(
  ...
  static pw.Widget buildInvoiceInfo(StockShippingInfo info) {
  ...
  static pw.Widget buildInvoiceHeaderCells(StockShipping shipping) {
  ...
  static pw.Widget buildInvoice(StockShipping shipping) {
    ...
    final data = shipping.items.map((item) {
  ...
  static pw.Widget buildInvoiceNewTotal(StockShipping shipping) {
    ...
    List<ShippingTotal> shippingTotals= [] ;
    String rowsCountTitle = (langId==1? "عدد الاصناف   ":"Total Items  ");
    String rowsCountValue =shipping.info.rowsCount.toString();
    String totalQtyTitle = (langId==1? "اجمالي الكمية":"Total Quantity  ");
    String totalQtyValue =shipping.info.totalQty.toString();
    ShippingTotal invoiceTotal1 =ShippingTotal( totalField1: totalQtyValue,totalField2: totalQtyTitle,totalField3:rowsCountValue ,totalField4:rowsCountTitle );
    shippingTotals.add(invoiceTotal1);
    ...
    final data = shippingTotals.map((item) {
  ...
  static pw.Widget buildTotal(StockShipping shipping) {
            ...
            child: pw.Column(
              ...
              children: [
                pw.Directionality(
                    textDirection: pw.TextDirection.rtl,
                    child: pw.Center(
                        child: pw.Text((langId==1? "عدد الاصناف   ":"Total Items  ") + shipping.info.rowsCount.toString(),
                            style: const pw.TextStyle(
                              fontSize: 15, )))),
                pw.Directionality(
                    textDirection: pw.TextDirection.rtl,
                    child: pw.Center(
                        child: pw.Text((langId==1? "اجمالي الكمية":"Total Quantity  ") + shipping.info.totalQty.toString(),
                            style: const pw.TextStyle(
                              fontSize: 15, )))),
                // pw.Directionality(
                //     textDirection: pw.TextDirection.rtl,
                ...
                //     textDirection: pw.TextDirection.rtl,
                //     child: pw.Center(
                //         child: pw.Text((langId==1? "الصافي ":"Net ") + shipping.info.totalAfterVat.toString(),
                //             style: const pw.TextStyle(
                //                 fontSize: 15 )))),
                // pw.Divider(),
                // pw.Directionality(
                //     textDirection: pw.TextDirection.rtl,
                //     child: pw.Center(
                //         child: pw.Text((langId==1? " الصافي كتابة ":"Net Tafqeet ") + shipping.info.tafqeetName.toString(),
                //             style: const pw.TextStyle(
                //                 fontSize: 15 )))),
  ...
  static pw.Widget buildFooter(ShippingReceipt receipt , pw.MemoryImage barcodeImage) => pw.Column(
      crossAxisAlignment: pw.CrossAxisAlignment.center,
      children: [
        pw.Divider(),
