...
import '../../../../../common/globals.dart';
 ...
 class CashSafeApiService {
  ...
  String searchApi= baseUrl.toString()  + 'v1/cashsafes/searchData';
  String createApi= baseUrl.toString()  + 'v1/cashsafes';
  String updateApi= baseUrl.toString()  + 'v1/cashsafes/';  // Add ID For Edit
  String deleteApi= baseUrl.toString()  + 'v1/cashsafes/';
  String getByIdApi= baseUrl.toString()  + 'v1/cashsafes/';  // Add ID For Get
