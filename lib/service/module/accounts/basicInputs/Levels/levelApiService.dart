...
class LevelApiService {
  ...
  String searchApi= baseUrl.toString()  + 'v1/workflowlevels/search';
  String createApi= baseUrl.toString()  + 'v1/workflowlevels';
  String updateApi= baseUrl.toString()  + 'v1/workflowlevels/';  // Add ID For Edit
  String deleteApi= baseUrl.toString()  + 'v1/workflowlevels/';
  String getByIdApi= baseUrl.toString()  + 'v1/workflowlevels/';  // Add ID For Get
