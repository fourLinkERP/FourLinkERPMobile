...
class _AddPlatformScreenState extends State<AddPlatformScreen> {
  ...
  TrainingCenterPlatformApiService api = TrainingCenterPlatformApiService();
  final _codeController = TextEditingController();
  final _nameAraController = TextEditingController();
  final _nameEngController = TextEditingController();
  final _platformLinkController = TextEditingController();
  ...
  void initState(){
    ...
    Future<NextSerial>  futureSerial = _nextSerialApiService.getNextSerial("TRC_TrainingCenterPlatforms", "TrainingCenterPlatformCode", " And CompanyCode=$companyCode And BranchCode=$branchCode" ).then((data) {
                    ...
                    Column(
                      children: [
                        ...
                        SizedBox(
                            width: 120,
                            height: 50,
                            child: Center(child: Text('platformLink'.tr(), style: const TextStyle(fontWeight: FontWeight.bold,fontSize: 15)))
                        ),
                        const SizedBox(height: 15),
                        SizedBox(
                            width: 120,
  ...
  savePlatform(BuildContext context) async{
    ...
    await api.createTrainingCenterPlatform(context,TrainingCenterPlatform(
        trainingCenterPlatformCode: _codeController.text ,
        trainingCenterPlatformNameAra: _nameAraController.text ,
        trainingCenterPlatformNameEng: _nameEngController.text ,
        trainingCenterPlatformUrl: _platformLinkController.text,
