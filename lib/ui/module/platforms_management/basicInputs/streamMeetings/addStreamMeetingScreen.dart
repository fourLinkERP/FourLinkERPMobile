...
class AddMeetingTypeScreen extends StatefulWidget {
  const AddMeetingTypeScreen({Key? key}) : super(key: key);

  @override
  State<AddMeetingTypeScreen> createState() => _AddMeetingTypeScreenState();
}
...
class _AddMeetingTypeScreenState extends State<AddMeetingTypeScreen> {
  ...
  void initState(){
    ...
    Future<NextSerial>  futureSerial = _nextSerialApiService.getNextSerial("TRC_TrainingCenterStreamMeetings", "StreamMeetingCode", " And CompanyCode=$companyCode And BranchCode=$branchCode" ).then((data) {
        ...
        title: Row(crossAxisAlignment: langId == 1 ? CrossAxisAlignment.end : CrossAxisAlignment.start,
          children: [
            ...
            Padding(
              ...
              child: Text('add_meeting_type'.tr(),
                    ...
                    Column(
                      children: [
                        ...
                        SizedBox(
                            width: 120,
                            height: 50,
                            child: Center(child: Text('meeting_link'.tr(), style: const TextStyle(fontWeight: FontWeight.bold,fontSize: 15)))
                        ),
                        const SizedBox(height: 15),
                        SizedBox(
                            width: 120,
