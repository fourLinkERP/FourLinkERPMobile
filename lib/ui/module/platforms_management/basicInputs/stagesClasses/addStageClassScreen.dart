...
import '../../../../../service/module/platforms_management/basicInputs/stagesClasses/stageClassApiService.dart';

NextSerialApiService _nextSerialApiService= NextSerialApiService();

class AddStageClassScreen extends StatefulWidget {
  const AddStageClassScreen({Key? key}) : super(key: key);

  @override
  State<AddStageClassScreen> createState() => _AddStageClassScreenState();
}

class _AddStageClassScreenState extends State<AddStageClassScreen> {

  StageClassApiService api = StageClassApiService();
  ...
  void initState(){
    ...
    Future<NextSerial>  futureSerial = _nextSerialApiService.getNextSerial("TRC_TrainingCenterEducationStagesClasses", "EducationStagesClassCode", " And CompanyCode=$companyCode And BranchCode=$branchCode" ).then((data) {
  ...
  saveStageClass(BuildContext context) async{
    ...
    await api.createStageClass(context,StageClass(
        educationStagesClassCode: _codeController.text ,
        educationStagesClassNameAra: _nameAraController.text ,
        educationStagesClassNameEng: _nameEngController.text ,
