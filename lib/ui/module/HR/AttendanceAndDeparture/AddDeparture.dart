...
class _AddDepartureDataWidgetState extends State<AddDepartureDataWidget> {
            ...
            Row(
              ...
              children: [
                Expanded(
                  child: Column(
                    children: [
                      buildButtonAttendRow("حضور   ATTEND ", Colors.green, Colors.transparent),
                      buildButtonDepartureRow("إنصراف  DEPART ", Colors.red, Colors.redAccent.withOpacity(0.3),_getCurrentTime),
                    ],
                  ),
                ),
  ...
  updateAttendance(BuildContext context) async
  {
    ...
    await api.updateAttendance(context, id,AttendanceAndDeparture(
      id: id,
