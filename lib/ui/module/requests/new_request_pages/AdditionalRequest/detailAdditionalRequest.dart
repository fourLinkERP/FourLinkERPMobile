...
class DetailAdditionalRequest extends StatefulWidget {
  DetailAdditionalRequest(this.requestH);

  final AdditionalRequestH requestH;

  @override
  State<DetailAdditionalRequest> createState() => _DetailAdditionalRequestState();
}

class _DetailAdditionalRequestState extends State<DetailAdditionalRequest> {

  AdditionalRequestHApiService api = AdditionalRequestHApiService();
  @override
                  ...
                  child: Column(
                    children: <Widget>[
                      Container(
                        ...
                        child: Column(
                          children: <Widget>[
                            Text('Serial: '.tr() + widget.requestH.trxSerial.toString(),
                                style: const TextStyle(color: Colors.black, fontWeight: FontWeight.bold)),
                            // const SizedBox(height: 15.0),
                            // Text('Employee: '.tr()  + widget.requestD.empName.toString(),
                            //     style: const TextStyle(color: Colors.black, fontWeight: FontWeight.bold)),
                            const SizedBox(height: 15.0),
                            Text('Cost center: '.tr()  + widget.requestH.costCenterName.toString(),
                                style: const TextStyle(color: Colors.black, fontWeight: FontWeight.bold)),
                          ...
                          children: <Widget>[
                            SizedBox(
                              ...
                              child: ElevatedButton.icon(
                                ...
                                onPressed: () {
                                  _navigateToEditScreen(context, widget.requestH);
                                },
                                style: ButtonStyle(
  ...
  _navigateToEditScreen(BuildContext context, AdditionalRequestH requestH) async {
    final result = await Navigator.push(
      context, MaterialPageRoute(builder: (context) => EditGeneralAdditionalRequest(requestH)),
    );
  }
