...
class AddCashPaymentOrderScreen extends StatefulWidget {
  ...
  @override
  State<AddCashPaymentOrderScreen> createState() => _AddCashPaymentOrderScreenState();
}
...
class _AddCashPaymentOrderScreenState extends State<AddCashPaymentOrderScreen> {
        ...
        title: Row(
          ...
          children: [
            ...
            Padding(
              ...
              child: Text('add_cash_payment'.tr(),
  ...
  _fillCompos(){
    ...
    Future<NextSerial>  futureSerial = _nextSerialApiService.getNextSerial("CM_PaymentOrders", "TrxSerial", " And CompanyCode=$companyCode And BranchCode=$branchCode" ).then((data) {
      NextSerial nextSerial = data;

      _trxSerialController.text = nextSerial.nextSerial.toString();
      _trxDateController.text = DateFormat('yyyy-MM-dd').format(DateTime.now());
  ...
  saveCashPaymentOrder(BuildContext context) async{
    ...
    await _api.createCashPaymentOrder(context,CashPaymentOrder(
