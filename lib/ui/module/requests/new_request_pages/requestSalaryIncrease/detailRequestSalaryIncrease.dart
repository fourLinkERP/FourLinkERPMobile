...
class DetailRequestSalary extends StatefulWidget {
  DetailRequestSalary(this.request);

  final SalaryIncRequests request;

  @override
  State<DetailRequestSalary> createState() => _DetailRequestSalaryState();
}

class _DetailRequestSalaryState extends State<DetailRequestSalary> {

  SalaryIncreaseApiService api = SalaryIncreaseApiService();
                      ...
                      Container(
                        ...
                        child: Column(
                          children: <Widget>[
                            ...
                            Text('Employee: '.tr()  + widget.request.empName.toString(),
                                style: const TextStyle(color: Colors.black, fontWeight: FontWeight.bold)),
                            const SizedBox(height: 15.0),
                            Text('Job: '.tr()  + widget.request.jobName.toString(),
                                style: const TextStyle(color: Colors.black, fontWeight: FontWeight.bold)),
  ...
  _navigateToEditScreen(BuildContext context, SalaryIncRequests request) async {
    final result = await Navigator.push(
      context, MaterialPageRoute(builder: (context) => EditRequestSalaryIncrease(request)),
    );
  }
