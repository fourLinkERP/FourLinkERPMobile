...
class DetailRequestResources extends StatefulWidget {
  DetailRequestResources(this.request);

  final ResourceRequests request;

  @override
  State<DetailRequestResources> createState() => _DetailRequestResourcesState();
}

class _DetailRequestResourcesState extends State<DetailRequestResources> {

  ResourceRequestApiService api = ResourceRequestApiService();
                  ...
                  child: Column(
                    children: <Widget>[
                      Container(
                        ...
                        child: Column(
                          children: <Widget>[
                            Text('Serial: '.tr() + widget.request.trxSerial.toString(),
                                style: const TextStyle(color: Colors.black, fontWeight: FontWeight.bold)),
                            const SizedBox(height: 15.0),
                            Text('Department: '.tr()  + widget.request.departmentName.toString(),
                                style: const TextStyle(color: Colors.black, fontWeight: FontWeight.bold)),
                            const SizedBox(height: 15.0),
                            Text('Cost center: '.tr()  + widget.request.costCenterName.toString(),
                                style: const TextStyle(color: Colors.black, fontWeight: FontWeight.bold)),
                          ...
                          children: <Widget>[
                            SizedBox(
                              ...
                              child: ElevatedButton.icon(
                                ...
                                onPressed: () {
                                  _navigateToEditScreen(context, widget.request);
                                },
                                style: ButtonStyle(
  ...
  _navigateToEditScreen(BuildContext context, ResourceRequests request) async {
    final result = await Navigator.push(
      context, MaterialPageRoute(builder: (context) => EditRequestResources(request)),
    );
  }
