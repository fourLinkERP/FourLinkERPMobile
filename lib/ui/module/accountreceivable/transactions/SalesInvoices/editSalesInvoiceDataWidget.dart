...
import 'package:fourlinkmobileapp/service/module/accountReceivable/basicInputs/TaxGroups/taxGroupApiService.dart';
      ...
      appBar:AppBar(
        ...
        title: Row(
          ...
          children: [
            ...
            Padding(
              padding: EdgeInsets.fromLTRB(0,11,2,0), //apply padding to all four sides
              child: Text('edit_sales_invoice'.tr(),style: TextStyle(color: Colors.white),),
            )
