...
import 'transactions/SalesOffers/salesOfferList.dart';
            ...
            child: Container(
              ...
              child: Material(
                ...
                child: InkWell(
                  ...
                  onTap: () {
                    if(imagepath == 'assets/fitness_app/salesCart.png') // Invoice
                    {
                      int menuId=6204;
                    ...
                    else if(imagepath == 'assets/fitness_app/quotion.png') //Quotion
                    {
                      int menuId=6202;
                      bool isAllowView = PermissionHelper.checkViewPermission(menuId);
                      if(isAllowView)
                    ...
                    else  if(imagepath == 'assets/fitness_app/inventory.png')//Orders
                    {
                      int menuId=6203;
                      bool isAllowView = PermissionHelper.checkViewPermission(menuId);
                      if(isAllowView)
                    ...
                    else if(imagepath == 'assets/fitness_app/accounting.png')//Cash
                    {
                      int menuId=3203;
                      bool isAllowView = PermissionHelper.checkViewPermission(menuId);
                      if(isAllowView)
                    ...
                    else if(imagepath == 'assets/fitness_app/sales_portion.png')
                    {
                      int menuId=6203;
                      bool isAllowView = PermissionHelper.checkViewPermission(menuId);
                      if(isAllowView)
