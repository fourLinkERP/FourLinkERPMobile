...
import '../../../../../data/model/modules/module/administration/basicInputs/branches/branch.dart';
import '../../../../../data/model/modules/module/administration/basicInputs/companies/company.dart';
...
import '../../../../../service/module/administration/basicInputs/branchApiService.dart';
import '../../../../../service/module/administration/basicInputs/compayApiService.dart';
...
class EditEmployeeDataWidget extends StatefulWidget {
  EditEmployeeDataWidget(this.employees);

  final Employee employees;

  @override
  _EditEmployeeDataWidgetState createState() => _EditEmployeeDataWidgetState();
}

class _EditEmployeeDataWidgetState extends State<EditEmployeeDataWidget> {
  _EditEmployeeDataWidgetState();
  ...
  void initState() {
    ...
    _employeeCodeController.text = widget.employees.empCode!;
    _employeeNameAraController.text = widget.employees.empNameAra!;
    selectedCompanyCode = widget.employees.companyCode.toString();
    selectedBranchCode = widget.employees.branchCode.toString();
    selectedJobCode = widget.employees.jobCode.toString();
    if(widget.employees.empNameEng != null){
      _employeeNameEngController.text = widget.employees.empNameEng!;
    }
    if(widget.employees.email != null){
      _employeeEmailController.text = widget.employees.email!;
    }
    if(widget.employees.password != null){
      _employeePasswordController.text = widget.employees.password!;
    }
    ...
    return Scaffold(
      floatingActionButton: FloatingActionButton(
        ...
        onPressed: () async {
          ...
          await api.updateEmployee(context,id,Employee(
