...
class RptDailyPurchases extends StatefulWidget {
  const RptDailyPurchases({Key? key}) : super(key: key);

  @override
  State<RptDailyPurchases> createState() => _RptDailyPurchasesState();
}

class _RptDailyPurchasesState extends State<RptDailyPurchases> {
        ...
        title: Row(crossAxisAlignment: langId == 1 ? CrossAxisAlignment.end : CrossAxisAlignment.start,
          children: [
            ...
            Padding(
              ...
              child: Text('dailyPurchaseReport'.tr(),
  ...
  printReport(BuildContext context ,String criteria){
    ...
    final report = reportUtilityApiService.getReportData(menuId,criteria , formulasList).then((data) async {
      ...
      final outputFilePath = 'DailyPurchasesReport.pdf';
