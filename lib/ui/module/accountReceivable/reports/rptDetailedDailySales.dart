...
class RptDetailedDailySales extends StatefulWidget {
  const RptDetailedDailySales({Key? key}) : super(key: key);

  @override
  State<RptDetailedDailySales> createState() => _RptDetailedDailySalesState();
}

class _RptDetailedDailySalesState extends State<RptDetailedDailySales> {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        title: ListTile(
          ...
          title: Text('detailedDailySalesReport'.tr(),
  ...
  printReport(BuildContext context ,String criteria){
    ...
    final report = reportUtilityApiService.getReportData(menuId,criteria , formulasList).then((data) async {
      ...
      final outputFilePath = 'DetailedDailySalesReport.pdf';
