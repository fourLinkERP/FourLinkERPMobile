...
import 'package:fourlinkmobileapp/data/model/modules/module/accountreceivable/transactions/branchRequests/branchRequestD.dart';
...
class AddBranchRequestDataWidget extends StatefulWidget {
  const AddBranchRequestDataWidget({Key? key}) : super(key: key);

  @override
  State<AddBranchRequestDataWidget> createState() => _AddBranchRequestDataWidgetState();
}

class _AddBranchRequestDataWidgetState extends State<AddBranchRequestDataWidget> {
  ...
  fillCompos() {
    Future<NextSerial>  futureSerial = _nextSerialApiService.getNextSerial("TBL_BranchRequestH", "TrxSerial", " And CompanyCode=$companyCode And BranchCode=$branchCode").then((data) {
