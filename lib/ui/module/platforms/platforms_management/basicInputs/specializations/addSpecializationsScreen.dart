...
import '../../../../../../service/module/platforms_management/basicInputs/specializations/specializationApiService.dart';

NextSerialApiService _nextSerialApiService = NextSerialApiService();

class AddSpecializationScreen extends StatefulWidget {
  const AddSpecializationScreen({Key? key}) : super(key: key);

  @override
  State<AddSpecializationScreen> createState() => _AddSpecializationScreenState();
}

class _AddSpecializationScreenState extends State<AddSpecializationScreen> {

  SpecializationApiService api = SpecializationApiService();
  ...
  void initState(){
    ...
    Future<NextSerial>  futureSerial = _nextSerialApiService.getNextSerial("TRC_TrainingCenterSpecializations", "SpecializationCode", " And CompanyCode=$companyCode And BranchCode=$branchCode" ).then((data) {
        ...
        title: Row(crossAxisAlignment: langId == 1 ? CrossAxisAlignment.end : CrossAxisAlignment.start,
          children: [
            ...
            Padding(
              ...
              child: Text('add_specialization'.tr(),
  ...
  saveSpecialization(BuildContext context) async{
    ...
    await api.createSpecialization(context,Specialization(
        specializationCode: _codeController.text ,
        specializationNameAra: _nameAraController.text ,
        specializationNameEng: _nameEngController.text ,
