...
class AddEducationSubjectScreen extends StatefulWidget {
  const AddEducationSubjectScreen({Key? key}) : super(key: key);

  @override
  State<AddEducationSubjectScreen> createState() => _AddEducationSubjectScreenState();
}

class _AddEducationSubjectScreenState extends State<AddEducationSubjectScreen> {

  final EducationSubjectApiService _api = EducationSubjectApiService();
  ...
  void initState(){
    ...
    Future<NextSerial>  futureSerial = _nextSerialApiService.getNextSerial("TRC_TrainingCenterEducationSubjects", "EducationSubjectCode", " And CompanyCode=$companyCode And BranchCode=$branchCode" ).then((data) {
  ...
  saveEducationSubject(BuildContext context) async{
    ...
    await _api.createEducationSubject(context,EducationSubject(
        educationSubjectCode: _codeController.text ,
        educationSubjectNameAra: _nameAraController.text ,
        educationSubjectNameEng: _nameEngController.text ,
