...
class AddEducationClassScreen extends StatefulWidget {
  const AddEducationClassScreen({Key? key}) : super(key: key);

  @override
  State<AddEducationClassScreen> createState() => _AddEducationClassScreenState();
}

class _AddEducationClassScreenState extends State<AddEducationClassScreen> {

  final EducationClassApiService _api = EducationClassApiService();
  ...
  void initState(){
    ...
    Future<NextSerial>  futureSerial = _nextSerialApiService.getNextSerial("TRC_TrainingCenterEducationClasses", "EducationClassCode", " And CompanyCode=$companyCode And BranchCode=$branchCode" ).then((data) {
  ...
  saveEducationClass(BuildContext context) async{
    ...
    await _api.createEducationClass(context,EducationClass(
        educationClassCode: _codeController.text ,
        educationClassNameAra: _nameAraController.text ,
        educationClassNameEng: _nameEngController.text ,
