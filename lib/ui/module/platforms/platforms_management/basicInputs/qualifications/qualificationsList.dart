...
import 'package:fourlinkmobileapp/service/module/platforms_management/basicInputs/qualifications/qualificationApiService.dart';
                    ...
                    subtitle: Column(
                      children: <Widget>[
                        ...
                        Container(
                            ...
                            child: Text("${'arabicName'.tr()} : ${_qualifications[index].qualificationNameAra}")),
                        Container(
                            height: 20,
                            color: Colors.white30,
                            child: Text("${'englishName'.tr()} : ${_qualifications[index].qualificationNameEng}")
                        ),
