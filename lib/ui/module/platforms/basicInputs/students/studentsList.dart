              ...
              return Card(
                child: InkWell(
                  child: ListTile(
                    ...
                    title: Text("${'code'.tr()} : ${_students[index].customerCode}",
                    ...
                    subtitle: Column(
                      children: <Widget>[
                        ...
                        Container(
                            ...
                            child: Text("${'arabicName'.tr()} : ${_students[index].customerNameAra}")),
                        Container(
                            height: 20,
                            color: Colors.white30,
                            child: Text("${'englishName'.tr()} : ${_students[index].customerNameEng}")
                        ),
