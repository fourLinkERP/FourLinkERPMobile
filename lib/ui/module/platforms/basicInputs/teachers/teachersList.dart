              ...
              return Card(
                child: InkWell(
                  child: ListTile(
                    ...
                    title: Text("${'code'.tr()} : ${_teachers[index].customerCode}",
                    ...
                    subtitle: Column(
                      children: <Widget>[
                        ...
                        Container(
                            ...
                            child: Text("${'arabicName'.tr()} : ${_teachers[index].customerNameAra}")),
                        Container(
                            height: 20,
                            color: Colors.white30,
                            child: Text("${'englishName'.tr()} : ${_teachers[index].customerNameEng}")
                        ),
